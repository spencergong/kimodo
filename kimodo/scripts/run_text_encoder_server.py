...
TEXT_ENCODER_PRESETS = {
    "llm2vec": {
        ...
        "kwargs": {
            "base_model_name_or_path": "spencer88/LLM2Vec-Meta-Llama-3-8B-Instruct-mntp",
            "peft_model_name_or_path": "Spencer88/LLM2Vec-Meta-Llama-3-8B-Instruct-mntp-supervised",
            "dtype": "bfloat16",
            "llm_dim": 4096,
        },
